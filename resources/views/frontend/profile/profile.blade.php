                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="edit-menu">
                            ...
                            <li><i class="icon ion-ios-settings"></i><a
                                    href="{{ route('client.user.account.settings') }}">Account Settings</a>
                            </li>
                            <li><i class="icon ion-ios-locked-outline"></i><a
                                    href="{{ route('client.user.change.password') }}">Change
                                    Password</a></li>
                        </ul>
                    </div>
                    <div class="col-md-7">
                        ...
                        <div class="edit-profile-container">
                            ...
                            <div class="edit-block">
                                <form name="basic-info" id="basic-info" class="form-inline"
                                    action="{{ route('client.update.user.profile') }}" method="POST">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-3 col-xs-6">
                                            ...
                                            <select class="form-control" id="month" name="month"
                                                ...
                                                @foreach (config('constants.month_list') as $key => $item)
                                                    <option value="{{ $key }}"
                                                        {{ $user->month == $i ? 'selected' : null }}>{{ $item }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group gender">
                                        ...
                                        <label class="radio-inline">
                                            <input type="radio" name="gender"
                                                {{ $user->gender == 'Male' ? 'checked' : null }} value="Male">Male
                                        </label>
                                        <label class="radio-inline">
                                            <input type="radio" name="gender"
                                                {{ $user->gender == 'Female' ? 'checked' : null }} value="Female">Female
                                        </label>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-xs-12">
                                            ...
                                            <textarea id="my-info" name="about_me" class="form-control" placeholder="Some texts about me" rows="4"
                                                cols="400">{{ $user->about_me }}</textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="feed-item">
                                    <div class="live-activity">
                                        <div class="follow-user">
                                            ...
                                            <div>
                                                <h5><a href="{{ route('client.news.feed') }}">{{ $item->full_name }}</a>
                                                </h5>
                                                <form action="{{ route('client.follow.user') }}" method="POST">
                                                    @csrf
                                                    <input type="hidden" name="user_id" value="{{ $item->id }}">
                                                    <button type="submit" class="btn btn-small text-green">Add
                                                        friend</button>
                                                </form>
                                            </div>
                                        </div>
